...
import com.qourall.yogaapp.ui.fragment.FavouriteFragmentDirections
import com.qourall.yogaapp.ui.fragment.PoseFragmentDirections
import com.qourall.yogaapp.utils.Utils.loadSvg


class FavPoseAdapter(private val context: Context, private val data: List<FavPose>) : RecyclerView.Adapter<FavPoseAdapter.PoseViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PoseViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action = FavouriteFragmentDirections.actionFavouriteFragmentToPoseDetailFragment(data[position].id)
